...
exports.PARTICIPANT_MAP = exports.TEST_PARTICIPANTS = void 0;
exports.seedParticipants = seedParticipants;
const crypto_1 = require("crypto");
exports.TEST_PARTICIPANTS = [
 ...
 */
exports.PARTICIPANT_MAP = new Map(exports.TEST_PARTICIPANTS.map((p) => [p.participantId, p]));
/**
...
async function seedParticipants(client) {
    for (const p of exports.TEST_PARTICIPANTS) {
        await client.query(`INSERT INTO "EventSubscription" (id, participant_id, proxy_type, proxy_value, endpoint_url, active)
       VALUES ($1, $2, $3, $4, $5, true)
       ON CONFLICT (participant_id) DO NOTHING`, [(0, crypto_1.randomUUID)(), p.participantId, p.proxyType, p.proxyValue, p.endpointUrl]);
    }
}
